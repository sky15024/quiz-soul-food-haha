...
window.__i18n = {
    ...
    resultText: {
        'zh-TW': [
            ...
            { name: "【異次元食怪】連達爾文都無法解釋的存在", desc: "你的飲食習慣已經徹底超越了人類的理解範圍！你確定你真的是地球人嗎？你的味覺構造絕對跟我們不一樣，那些對人類來說是劇毒或反胃的組合，對你來說卻是珍饈美味。外星特務請直接自首，或者趕快把這個測驗散佈出去，尋找潛伏在地球上的同類，不然你真的會被抓去解剖研究的！" },
        ...
        'en': [
            ...
            { name: "[Interdimensional Food Monster] Darwin Can't Explain You", desc: "Your eating habits have entirely transcended human comprehension! Are you absolutely sure you're from Earth? Your taste receptors are definitely not built like ours. Combos that are toxic or nauseating to humans are delicacies to you. Alien spies, please turn yourselves in immediately—or spread this quiz to find your fellow extraterrestrials before you get dissected for science!" },
